...
import com.gmail.renish.ecommerce.dto.PasswordResetRequest;
import com.gmail.renish.ecommerce.dto.auth.AuthenticationRequest;
...
public class AuthenticationControllerTest {
    ...
    public void forgotPassword() throws Exception {
        mockMvc.perform(get(PathConstants.API_V1_AUTH + PathConstants.FORGOT_EMAIL, USER_EMAIL)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void forgotPassword_ShouldEmailBeNotValid() throws Exception {
        mockMvc.perform(get(PathConstants.API_V1_AUTH + PathConstants.FORGOT_EMAIL, EMAIL_FAILURE)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getPasswordResetCode() throws Exception {
        mockMvc.perform(get(PathConstants.API_V1_AUTH + PathConstants.RESET_CODE, USER_PASSWORD_RESET_CODE)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
