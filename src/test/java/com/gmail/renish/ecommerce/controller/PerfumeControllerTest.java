...
import com.gmail.renish.ecommerce.dto.perfume.PerfumeSearchRequest;
import com.gmail.renish.ecommerce.dto.perfume.SearchTypeRequest;
...
public class PerfumeControllerTest {
    ...
    public void getAllPerfumes() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.API_V1_PERFUMES)
    ...
    public void getPerfumeById() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.API_V1_PERFUMES + PathConstants.PERFUME_ID, 1)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void getPerfumeById_ShouldNotFound() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(PathConstants.API_V1_PERFUMES + PathConstants.PERFUME_ID, 1111)
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getPerfumesByIds() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.API_V1_PERFUMES + PathConstants.IDS)
    ...
    public void findPerfumesByFilterParams() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.API_V1_PERFUMES + PathConstants.SEARCH)
    ...
    public void findByPerfumeGender() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.API_V1_PERFUMES + PathConstants.SEARCH_GENDER)
                        .content(mapper.writeValueAsString(filter))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*].id").isNotEmpty())
    ...
    public void findByPerfumer() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.API_V1_PERFUMES + PathConstants.SEARCH_PERFUMER)
                        .content(mapper.writeValueAsString(filter))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*].id").isNotEmpty())
    ...
    public void findByInputText() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.API_V1_PERFUMES + PathConstants.SEARCH_TEXT)
    ...
    public void getPerfumesByIdsQuery() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.API_V1_PERFUMES + PathConstants.GRAPHQL_IDS)
    ...
    public void getAllPerfumesByQuery() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.API_V1_PERFUMES + PathConstants.GRAPHQL_PERFUMES)
                        .content(mapper.writeValueAsString(graphQLRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void getPerfumeByQuery() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(PathConstants.API_V1_PERFUMES + PathConstants.GRAPHQL_PERFUME)
                        .content(mapper.writeValueAsString(graphQLRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
